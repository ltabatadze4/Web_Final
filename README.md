...
ვებ-აპლიკაცია წიგნების მოსაძიებლად, ეკრანიზაციების გასაცნობად და პირადი შკაფის სამართავად. აგებულია **სუფთა Vanilla JavaScript-ით** (ES Modules) — ბანდლერის, ფრეიმვორქის და build ინსტრუმენტების გარეშე.
